...
namespace Microsoft.EntityFrameworkCore.Storage
{
    public static class RelationalCommandExtensions
    {
        ...
        public static int ExecuteNonQuery(
            ...
            => command.ExecuteNonQuery(connection, null);
        ...
        public static Task<int> ExecuteNonQueryAsync(
            ...
            => command.ExecuteNonQueryAsync(connection, null, cancellationToken);
        ...
        public static object ExecuteScalar(
            [NotNull] this IRelationalCommand command,
            [NotNull] IRelationalConnection connection)
            => command.ExecuteScalar(connection, null);
        ...
        public static Task<object> ExecuteScalarAsync(
            ...
            [NotNull] IRelationalConnection connection,
            CancellationToken cancellationToken = default(CancellationToken))
            => command.ExecuteScalarAsync(connection, null, cancellationToken);
        ...
        public static RelationalDataReader ExecuteReader(
            [NotNull] this IRelationalCommand command,
            [NotNull] IRelationalConnection connection)
            => command.ExecuteReader(connection, null);
        ...
        public static Task<RelationalDataReader> ExecuteReaderAsync(
            ...
            [NotNull] IRelationalConnection connection,
            CancellationToken cancellationToken = default(CancellationToken))
            => command.ExecuteReaderAsync(connection, null, cancellationToken);
    }
}
